...
public class VentanaAdministrador extends JFrame {
	...
	public VentanaAdministrador() {
		...
		comboBox.setModel(
				new DefaultComboBoxModel<String>(new String[] { " Móviles ", " Ordenadores ", " Electrodomésticos " }));
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (comboBox.getSelectedIndex() == 0) {
					...
					Moviles m = new Moviles(textField.getText(), Integer.parseInt(textField1.getText()),
							textField2.getText(), Double.parseDouble(textField3.getText()), textField4.getText(),
							Double.parseDouble(textField5.getText()), textField6.getText(),
							Integer.parseInt(textField7.getText()), textField8.getText());
					BD.movilInsert(st, m);
				}
				if (comboBox.getSelectedIndex() == 1) {
					Statement st = BD.usarCrearTablaOrdenador(con);
					Ordenadores o = new Ordenadores(textField9.getText(), Integer.parseInt(textField10.getText()),
							textField11.getText(), Double.parseDouble(textField12.getText()), textField13.getText(),
							textField14.getText(), textField15.getText(), textField16.getText(),
							Double.parseDouble(textField17.getText()));
					BD.ordenadorInsert(st, o);
				}
				if (comboBox.getSelectedIndex() == 2) {
					Statement st = BD.usarCrearTablaElectrodomestico(con);
					Electrodomesticos el = new Electrodomesticos(textField18.getText(),
							Integer.parseInt(textField19.getText()), textField20.getText(),
							Double.parseDouble(textField21.getText()), textField22.getText(), textField23.getText(),
							textField24.getText(), Integer.parseInt(textField25.getText()),
							Double.parseDouble(textField26.getText()));
